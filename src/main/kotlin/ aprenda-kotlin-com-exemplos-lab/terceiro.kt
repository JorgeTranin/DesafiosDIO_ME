package ` aprenda-kotlin-com-exemplos-lab`
...
fun main() {
    ...
    val moduleKotlinI = EducationalContent("Orientação a objeto POO", 180, Level.INTERMEDIARY)
    ...
    val guilherme = Users("guilherme","santos", "guilhermesantos@gmail.com", Post.STUDENT)
    val rafael = Users("rafael","collioni", "rafacollioni@gmail.com", Post.STUDENT)
    ...
    androidTraining.addUser(guilherme)
    androidTraining.addUser(rafael)
